...
data_ip="https://raw.githubusercontent.com/ataaxd/accs/main/ip"
checking_sc() {
  ...
  if [[ $date_list < $useexp ]]; then
    ...
    echo -e "      ${GREEN}TELEGRAM${NC} t.me/revoerid"
    echo -e "\033[1;93m────────────────────────────────────────────\033[0m"
    exit 0
  fi
}
checking_sc
  # // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e " REVOERTUNNEL AUTOSCRIPT PREMIUM${YELLOW}(${NC}${green}Stable Edition${NC}${YELLOW})${NC}"
echo -e " PROSES PENGECEKAN IP ADDRESS ANDA !!"
echo -e "${purple}----------------------------------------------------------${NC}"
echo -e " ›DEVELOPER : ${green}RevoeR ${NC}${YELLOW}(${NC}${green}V 3.2${NC}${YELLOW})${NC}"
echo -e " ›Powered By REVOERTUNNEL ${YELLOW}(${NC} ©2024 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 2
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/ataaxd/revoertunnel/main/"
...
echo -e "\e[32mloading...\e[0m" 
clear
izinsc="https://raw.githubusercontent.com/ataaxd/accs/main/ip"
# USERNAME
rm -f /usr/bin/user
...
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ","url":"t.me/@revoerid"}]]}' 
...
wget -q https://raw.githubusercontent.com/ataaxd/revoertunnel/main/config/fv-tunnel && chmod +x fv-tunnel && ./fv-tunnel
